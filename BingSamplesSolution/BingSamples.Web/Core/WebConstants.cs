...
{
    public const string AppOptionsSectionName = "App";
    public const string SearchBaseEndpoint = "https://api.bing.microsoft.com/v7.0/";
    public const string SearchBaseVirtual = "search";
